...
use super::{
    fields, get_foreign_type_argument, is_many_to_many, make_ident_literal_str, many_table_lit,
};
use crate::codegen::{get_default_lit, is_auto, is_row_field, is_unique, pk_field};
...
pub fn fields_type_tokens(ast_struct: &ItemStruct) -> TokenStream2 {
