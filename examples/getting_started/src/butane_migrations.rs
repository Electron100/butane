...
pub fn get_migrations() -> Result<MemMigrations, butane::Error> {
  ...
  "migrations": {
    ...
    "20201229_171630604_likes": {
      ...
      "up": {
        "libsql": "ALTER TABLE Post ADD COLUMN likes INTEGER NOT NULL DEFAULT 0;\n",
      ...
      "down": {
        "libsql": "ALTER TABLE Post DROP COLUMN likes;\n",
