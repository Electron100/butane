  ...
  "migrations": {
    "20201229_144636751_init": {
      ...
      "up": {
        ...
        "turso": "CREATE TABLE Blog (\"id\" INTEGER NOT NULL PRIMARY KEY, \"name\" TEXT NOT NULL);\nCREATE TABLE Post (\"id\" INTEGER NOT NULL PRIMARY KEY, title TEXT NOT NULL, body TEXT NOT NULL, published INTEGER NOT NULL, blog INTEGER NOT NULL, byline TEXT);\nCREATE TABLE Post_tags_Many (\"owner\" INTEGER NOT NULL, has TEXT NOT NULL);\nCREATE TABLE \"Tag\" (\"tag\" TEXT NOT NULL PRIMARY KEY);\nCREATE TABLE IF NOT EXISTS butane_migrations (\"name\" TEXT NOT NULL PRIMARY KEY);\n"
      },
      "down": {
    ...
    "20201229_171630604_likes": {
      ...
      "up": {
        ...
        "turso": "ALTER TABLE Post ADD COLUMN likes INTEGER NOT NULL DEFAULT 0;\n"
      },
      "down": {
        "pg": "ALTER TABLE Post DROP COLUMN likes;\n",
        "sqlite": "ALTER TABLE Post DROP COLUMN likes;\n",
        "turso": "ALTER TABLE Post DROP COLUMN likes;\n"
      }
    },
    "20240115_023841384_dbconstraints": {
      ...
      "up": {
        ...
        "turso": "CREATE TABLE Post__butane_tmp (\"id\" INTEGER NOT NULL PRIMARY KEY, title TEXT NOT NULL, body TEXT NOT NULL, published INTEGER NOT NULL, blog INTEGER NOT NULL, byline TEXT, likes INTEGER NOT NULL, FOREIGN KEY (blog) REFERENCES Blog(\"id\"));\nINSERT INTO Post__butane_tmp SELECT \"id\", title, body, published, blog, byline, likes FROM Post;\nDROP TABLE Post;\nALTER TABLE Post__butane_tmp RENAME TO Post;\nCREATE TABLE Post_tags_Many__butane_tmp (\"owner\" INTEGER NOT NULL, has TEXT NOT NULL, FOREIGN KEY (has) REFERENCES \"Tag\"(\"tag\"));\nINSERT INTO Post_tags_Many__butane_tmp SELECT \"owner\", has FROM Post_tags_Many;\nDROP TABLE Post_tags_Many;\nALTER TABLE Post_tags_Many__butane_tmp RENAME TO Post_tags_Many;\nCREATE TABLE Post_tags_Many__butane_tmp (\"owner\" INTEGER NOT NULL, has TEXT NOT NULL, FOREIGN KEY (\"owner\") REFERENCES Post(\"id\"), FOREIGN KEY (has) REFERENCES \"Tag\"(\"tag\"));\nINSERT INTO Post_tags_Many__butane_tmp SELECT \"owner\", has FROM Post_tags_Many;\nDROP TABLE Post_tags_Many;\nALTER TABLE Post_tags_Many__butane_tmp RENAME TO Post_tags_Many;\n"
      },
      "down": {
        ...
        "sqlite": "CREATE TABLE Post__butane_tmp (\n\"id\" INTEGER NOT NULL PRIMARY KEY,\ntitle TEXT NOT NULL,\nbody TEXT NOT NULL,\npublished INTEGER NOT NULL,\nblog INTEGER NOT NULL,\nbyline TEXT,\nlikes INTEGER NOT NULL\n) STRICT;\nINSERT INTO Post__butane_tmp SELECT \"id\", title, body, published, blog, byline, likes FROM Post;\nDROP TABLE Post;\nALTER TABLE Post__butane_tmp RENAME TO Post;\nCREATE TABLE Post_tags_Many__butane_tmp (\n\"owner\" INTEGER NOT NULL,\nhas TEXT NOT NULL,\nFOREIGN KEY (\"owner\") REFERENCES Post(\"id\")\n) STRICT;\nINSERT INTO Post_tags_Many__butane_tmp SELECT \"owner\", has FROM Post_tags_Many;\nDROP TABLE Post_tags_Many;\nALTER TABLE Post_tags_Many__butane_tmp RENAME TO Post_tags_Many;\nCREATE TABLE Post_tags_Many__butane_tmp (\n\"owner\" INTEGER NOT NULL,\nhas TEXT NOT NULL\n) STRICT;\nINSERT INTO Post_tags_Many__butane_tmp SELECT \"owner\", has FROM Post_tags_Many;\nDROP TABLE Post_tags_Many;\nALTER TABLE Post_tags_Many__butane_tmp RENAME TO Post_tags_Many;\n",
        "turso": "CREATE TABLE Post__butane_tmp (\"id\" INTEGER NOT NULL PRIMARY KEY, title TEXT NOT NULL, body TEXT NOT NULL, published INTEGER NOT NULL, blog INTEGER NOT NULL, byline TEXT, likes INTEGER NOT NULL);\nINSERT INTO Post__butane_tmp SELECT \"id\", title, body, published, blog, byline, likes FROM Post;\nDROP TABLE Post;\nALTER TABLE Post__butane_tmp RENAME TO Post;\nCREATE TABLE Post_tags_Many__butane_tmp (\"owner\" INTEGER NOT NULL, has TEXT NOT NULL, FOREIGN KEY (\"owner\") REFERENCES Post(\"id\"));\nINSERT INTO Post_tags_Many__butane_tmp SELECT \"owner\", has FROM Post_tags_Many;\nDROP TABLE Post_tags_Many;\nALTER TABLE Post_tags_Many__butane_tmp RENAME TO Post_tags_Many;\nCREATE TABLE Post_tags_Many__butane_tmp (\"owner\" INTEGER NOT NULL, has TEXT NOT NULL);\nINSERT INTO Post_tags_Many__butane_tmp SELECT \"owner\", has FROM Post_tags_Many;\nDROP TABLE Post_tags_Many;\nALTER TABLE Post_tags_Many__butane_tmp RENAME TO Post_tags_Many;\n"
      }
    }
  },
  "current": {
