...
pub fn get_migrations() -> Result<MemMigrations, butane::Error> {
  ...
  "migrations": {
    ...
    "20201229_171630604_likes": {
      ...
      "up": {
        "mysql": "ALTER TABLE Post ADD COLUMN likes INT NOT NULL DEFAULT 0;\n",
      ...
      "down": {
        "mysql": "ALTER TABLE Post DROP COLUMN likes;\n",
