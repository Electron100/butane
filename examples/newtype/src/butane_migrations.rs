  ...
  "migrations": {
    "20240401_095709389_init": {
      ...
      "up": {
        ...
        "turso": "CREATE TABLE Blog (\"id\" BLOB NOT NULL PRIMARY KEY, \"name\" TEXT NOT NULL);\nCREATE TABLE Post (\"id\" BLOB NOT NULL PRIMARY KEY, title TEXT NOT NULL, body TEXT NOT NULL, published INTEGER NOT NULL, blog BLOB NOT NULL, byline TEXT, likes INTEGER NOT NULL, FOREIGN KEY (blog) REFERENCES Blog(\"id\"));\nCREATE TABLE Post_tags_Many (\"owner\" BLOB NOT NULL, has TEXT NOT NULL, FOREIGN KEY (\"owner\") REFERENCES Post(\"id\"), FOREIGN KEY (has) REFERENCES \"Tag\"(\"tag\"));\nCREATE TABLE \"Tag\" (\"tag\" TEXT NOT NULL PRIMARY KEY);\nCREATE TABLE IF NOT EXISTS butane_migrations (\"name\" TEXT NOT NULL PRIMARY KEY);\n"
      },
      "down": {
    ...
    "20240406_035726416_tags": {
      ...
      "down": {
        ...
        "turso": "CREATE TABLE Post_tags_Many (\"owner\" BLOB NOT NULL, has TEXT NOT NULL, FOREIGN KEY (\"owner\") REFERENCES Post(\"id\"), FOREIGN KEY (has) REFERENCES \"Tag\"(\"tag\"));\nCREATE TABLE \"Tag\" (\"tag\" TEXT NOT NULL PRIMARY KEY);\nALTER TABLE Post DROP COLUMN tags;\n"
      }
    }
  },
  "current": {
