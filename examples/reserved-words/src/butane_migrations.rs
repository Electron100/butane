...
pub fn get_migrations() -> Result<MemMigrations, butane::Error> {
  ...
  "migrations": {
    ...
    "20250504_001654915_add-fkey": {
      ...
      "down": {
        "mysql": "ALTER TABLE Post DROP FOREIGN KEY Post_byline_fkey;\nDROP TABLE Post;\n",
